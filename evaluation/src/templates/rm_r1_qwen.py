"""RM-R1-Qwen2.5-Instruct-32B template."""

from ._base import EvalPromptTemplate, make_extractor

RM_R1_Qwen2_5_Instruct_32B = EvalPromptTemplate(
    template_name="RM_R1_Qwen2_5_Instruct_32B",
    formatted_prompt=None,
    listwise_answer_extractor=make_extractor(r"<answer>\[\[([A-D])\]\]</answer>"),
